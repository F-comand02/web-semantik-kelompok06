...
## Hasil validasi
- JSON-LD Playground: JSON-LD berhasil diproses tanpa galat sintaks. Hasil pemrosesan menunjukkan bahwa URI subjek yang digunakan adalah `https://f-comand02.github.io/web-semantik-kelompok06/pertemuan-04/sumber-   belajar`, sama seperti URI pada metadata Turtle. Data seperti judul, pembuat, deskripsi, tanggal, bahasa, dan hak juga berhasil ditampilkan sebagai RDF.
- Schema Markup Validator: Metadata Schema.org telah disusun menggunakan vocabulary Schema.org dan URI yang sama dengan metadata Turtle dan JSON-LD. Hasil validasi menunjukkan bahwa data dapat diproses oleh        Schema Markup Validator.
